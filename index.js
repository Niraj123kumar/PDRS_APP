...
// === 🔐 SECURITY & CORE MIDDLEWARE (MUST COME BEFORE ROUTES) ===
app.use(cors({ 
...
// ✅ Body parsing - CRITICAL for req.body to work
...
// === 📤 Rubric Upload Route ===
app.post('/api/panel/room/:roomCode/rubric', 
  (req, res, next) => {
...
// === 🛣️ API Routes (middleware applied BEFORE routes) ===
app.use('/api/', limiter);
